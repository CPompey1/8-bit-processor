...
HD_PWD='C:/Users/cpomp/workspace/work_sub/CSE490/CSE490-Project1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_cpu_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mips_cpu_8.tcl -notrace
