...
HD_PWD='C:/Users/cpomp/workspace/work_sub/CSE490/CSE490-Project1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_cpu_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mips_cpu_8.tcl
