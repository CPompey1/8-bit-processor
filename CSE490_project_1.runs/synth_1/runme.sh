...
HD_PWD='C:/Users/cpomp/workspace/CSE490_project_1/CSE490_project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log halfadd_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source halfadd_test.tcl
